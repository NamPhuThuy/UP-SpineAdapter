...
namespace NamPhuThuy.SpineAdapter
{
    ...
    public class SpineUsageExamples : MonoBehaviour
    {
        ...
        void Example_ChainedAnimations()
        {
            ...
            outro.Complete += (entry) => { SpineManager.Ins.Recycle(character); };
        }
...
// ============================================================
    public static class SpinePoolingExtensions
    {
        ...
        /// </summary>
        public static SkeletonAnimation SpawnAt(this SpineAnimationType type, GameObject target, string animName = null,
            bool loop = false)
        {
        ...
        /// </summary>
        public static SkeletonAnimation SpawnFollowing(this SpineAnimationType type, Transform target, string animName,
            bool loop = false)
        {
