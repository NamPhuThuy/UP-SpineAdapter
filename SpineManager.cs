...
namespace NamPhuThuy.SpineAdapter
{
    ...
    public partial class SpineManager : Singleton<SpineManager>
    {
        ...
        [Header("Example Prefabs")] public SkeletonAnimation like_skeAnim;
        public SkeletonGraphic like_skeGrap;

        [Header("Pool Configuration")] [SerializeField]
        private SpinePoolConfig[] animationPools;
        ...
        /// </summary>
        public SkeletonAnimation SpawnTimed(SpineAnimationType type, Vector3 position, float duration,
        ...
        /// </summary>
        public SkeletonAnimation SpawnAutoRecycle(SpineAnimationType type, Vector3 position, string animationName,
            bool loop = false, Transform parent = null)
        {
            SkeletonAnimation anim = Spawn(type, position, parent);
            if (anim != null)
            {
        ...
        /// </summary>
        public SkeletonGraphic SpawnAutoRecycle(SpineGraphicType type, string animationName, bool loop = false,
            Transform parent = null)
        {
        ...
        public void LogPoolStatistics()
        {
            ...
            foreach (var kvp in _animationPools)
            {
                ...
                Debug.Log(
                    $"[Animation] {type}: Pooled={pooled}, Active={active}, Spawned={spawned}, Recycled={recycled}");
            }
            ...
            foreach (var kvp in _graphicPools)
            {
                ...
                Debug.Log(
                    $"[Graphic] {type}: Pooled={pooled}, Active={active}, Spawned={spawned}, Recycled={recycled}");
            }
        }
